...
class PropietarioInsertActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_propietario_insert)
        ...
        val toolbar: Toolbar = findViewById(R.id.toolbarInsertPropietario)
        setSupportActionBar(toolbar)
        supportActionBar?.title = "Insertar Propietario"
