...
class InmuebleViewActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_inmueble_view)
        ...
        val toolbar: Toolbar = findViewById(R.id.toolbarViewInmueble)
        setSupportActionBar(toolbar)
        supportActionBar?.title = "Ver Inmuebles"
