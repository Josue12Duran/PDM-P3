...
class InmuebleInsertActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_inmueble_insert)
        ...
        val toolbar: Toolbar = findViewById(R.id.toolbarInsertInmueble)
        setSupportActionBar(toolbar)
        supportActionBar?.title = "Insertar Inmueble"
